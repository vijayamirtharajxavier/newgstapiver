...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url();?>buttons.html">Buttons</a>
            <a class="collapse-item" href="<?php echo base_url();?>cards.html">Cards</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo base_url();?>#" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url();?>utilities-color.html">Colors</a>
            <a class="collapse-item" href="<?php echo base_url();?>utilities-border.html">Borders</a>
            <a class="collapse-item" href="<?php echo base_url();?>utilities-animation.html">Animations</a>
            <a class="collapse-item" href="<?php echo base_url();?>utilities-other.html">Other</a>
          </div>
        </div>
      </li>
      ...
      <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo base_url();?>#" data-toggle="collapse" data-target="#collapsePages" aria-expanded="true" aria-controls="collapsePages">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url();?>login.html">Login</a>
            <a class="collapse-item" href="<?php echo base_url();?>register.html">Register</a>
            <a class="collapse-item" href="<?php echo base_url();?>forgot-password.html">Forgot Password</a>
            <div class="collapse-divider"></div>
            <h6 class="collapse-header">Other Pages:</h6>
            <a class="collapse-item" href="<?php echo base_url();?>404.html">404 Page</a>
            <a class="collapse-item" href="<?php echo base_url();?>blank.html">Blank Page</a>
          </div>
        </div>
      </li>
