...
<div id="delete-gstr3b-message"></div>
            ...
            <div class="card-header">3.1 Details of Outward Suplies and inward supplies liable to reverse charge</div>


                <!--<div id="gstr3b_list"></div>-->
              </div>
            </div>
<div id="gstr3bdata"></div>
          </div>
...
<div id="delete-gstr3b-message"></div>
            ...
            <div class="card-body">
              <div class="table-responsive">
            <div class="card-header">3.2 Of the supplies shown in 3.1 (a), details of inter-state supplies made to unregistered persons, composition taxable person and UIN holders</div>


                <!--<div id="gstr3b_list"></div>-->
              </div>
            </div>
<div id="gstr32bdata"></div>
          </div>
...
<div id="delete-gstr3b-message"></div>
            ...
            <div class="card-body">
              <div class="table-responsive">
            <div class="card-header">4. Eligible ITC</div>
...
<div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
            <div class="card-header">5. Exempt, nill and Non GST inward supplies</div>


                <!--<div id="gstr3b_list"></div>-->
              </div>
            </div>
<div id="gstr3b5data"></div>
          </div>
...
<script src="<?php echo base_url();?>assets/js/gstr3b.js"></script>
