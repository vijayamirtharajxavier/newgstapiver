...
<?php  include 'layouts/navbar.php';  ?>
        ...
        <form class="text-center" style="color: #757575;" action="addPurchase" method="POST" id="addPurchaseForm">
...
<div class="pull-right" id="add-purchase-message"></div>
<div class="pull-right" id="error-purchase-message"></div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Vendor Name<select class="form-control" name="vendor_name" autocomplete="off"  id="vendor_name" required></select></div>
...
<!--<div class="input-group pull-right">
  <div class="input-group-prepend">
    <span class="input-group-text" id="inputGroup-sizing-sm">Total Item(s) : &nbsp;</span>
  </div>
  <input type="text" id="ticount" name="ticount" readonly>
</div> -->
...
$(document).on('click','.remove',function(){
  ...
  $('#' + delete_row).remove();
 x = document.getElementById("purTable").rows.length-1;
//console.log('X' +x);
$('#ticount').html(x);
calcnetTotal();
//update_total();
