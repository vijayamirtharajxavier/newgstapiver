...
<tr><td>Product Name<input type="text" class="form-control productname" autocomplete="off" required  id="productname" name="productname" ></td><td>Description<input type="text" class="form-control" autocomplete="off"  id="productdesc" name="productdesc" ></td><td>HSNSAC<input type="text" class="form-control" autocomplete="off" id="producthsnsac" name="producthsnsac" required></td><td>GST%<input type="text" class="form-control" autocomplete="off"  id="productgstpc" name="productgstpc" required></td></tr><tr><td>UNIT <input type="text" style="text-align: right;" autocomplete="off" class="form-control" id="trans_amount" name="trans_amount"></td><td>Trans Ref#<input type="text" class="form-control" autocomplete="off"  id="transref" name="transref"></td><td colspan="2">Narration<input type="text" class="form-control" autocomplete="off"  id="narration" name="narration"></td></tr>
</table>
    ...
    <div class="card-body px-lg-5 pt-0">
            ...
            <div class="form-row">
                ...
                <div class="col">
                    <!-- Last name -->
                    <div class="md-form">
                        <label for="productstock">Type</label>
