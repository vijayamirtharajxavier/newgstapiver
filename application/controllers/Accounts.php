...
//$tbl_head .= str_replace(",", " | ", $this->session->userdata('cadd') ) . ' <br /> ' . "Phone :" . $this->session->userdata('contact') . " | E-mail :" . $this->session->userdata('email');
		...
		$url=$this->config->item("api_url") . "/api/productlist/accountstransactionbyid";
